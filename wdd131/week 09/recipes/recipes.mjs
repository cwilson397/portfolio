const recipes = [
    ...
    },
    {
        ...
        recipeInstructions: [
            ...
            'Blend flour into bacon drippings then stir in the milk until the flour is well mixed. Stir in water, applesauce, tomato paste, curry, and bouillon, and garlic.',
    ...
    },
    {
        ...
        recipeInstructions: [
            ...
            'Bake in the preheated oven until the topping is golden brown, about 45 minutes. Serve with vanilla ice cream if desired.'
        ],
