...
# Indexes for inner lists in periodic table
NAME_INDEX = 0
ATOMIC_MASS_INDEX = 1

# Indexes for inner lists in a symbol_quanitity_list
SYMBOL_INDEX = 0
QUANTITY_INDEX = 1
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    Parameters:
        symbol_quantity_list: A compound list returned from parse_formula.
        periodic_table_dict: The compound dictionary returned from make_periodic_table.

    Returns:
        The total molar mass of the elements in symbol_quantity_list.
    """
    total_molar_mass = 0
...
def main():
    ...
    # Call the parse_formula function to convert the chemical formula
    # given by the user to a compound list that stores element symbols
    # and the quantity of atoms of each element in the molecule.
    symbol_quantity_list = parse_formula(formula, periodic_table)

    # Call the compute_molar_mass function to compute the molar mass
    # of the molecule from the compound list.
    ...
    print(f"Number of moles in the sample: {number_of_moles:.5f} mol")
